...
typedef enum 
{   
    /*InterruptName*/                       /*VectorTableNumber*/
    INTERRUPT_INIT_SP							=    0   ,
    INTERRUPT_Reset 							=    1   ,
    INTERRUPT_NMI                     			=    2   ,
    ...
    INTERRUPT_16_32_Timer_0A                   		=   35   ,
    INTERRUPT_16_32_Timer_0B                   		=   36   ,
    INTERRUPT_16_32_Timer_1A                   		=   37   ,
    INTERRUPT_16_32_Timer_1B                   		=   38   ,
    INTERRUPT_16_32_Timer_2A                   		=   39   ,
    INTERRUPT_16_32_Timer_2B                   		=   40   ,
